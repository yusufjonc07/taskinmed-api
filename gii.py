...
from db import ActiveSession, engine
...
=======
    table_names = ['recipe']
>>>>>>> 78ea4664cc9f61770e2222cfa535c36d87755bf3
    ...
    for table_name in table_names:
        ...
        model_content = model_content + "from db import Base \n \n" 
        ...
        router_content= router_content + f"\nfrom functions.{table_name} import *"
        router_content = router_content + f"\nfrom models.{table_name} import *"
        router_content = router_content + f"\nfrom schemas.{table_name} import *"
        ...
        for column in inspector.get_columns(table_name, schema='admin_dbsync'):
            ...
            if str(column['name']) == 'id':
                ...
                if str(column['name'])[-3:] == '_id':
                    ...
                    relates_sources =  relates_sources + f"from models.{str(column['name'])[:-3]} import * \n"
                else:
                    foreign = ''
